	...
	<tbody>
		<tr>
			...
			<td style="text-align: left;">
				...
				style="margin-top: 1px; background-color: #614051; border-bottom: 1px solid black">
				<tr style="height:47px">
				<td width="20px">&nbsp;</td>
				<td width="500" valign="bottom" style="text-align:left">
				<a href="index.php">
						<img style="border: 0px solid ; height: 25px;" alt="FLYKO" src="../bilder/flyttekoordineringsgruppa.png" hspace="0" vspace="0" />
				</a>
			</td>
