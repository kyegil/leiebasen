...
?>
			...
			},
			{
				...
				items: [{
					xtype: 'radio',
					boxLabel: "Ja. <?=($_POST['er_org'] ? 'Virksomheten' : 'Personen')?> oppført til venstre er den som skal inn som framleier",
...
?>
		...
		{
			xtype: 'radio',
			boxLabel: "Nei. <?=(!$_POST['er_org'] ? ($_POST['fornavn'] . ' ') : '') . $_POST['etternavn']?> er nok ikke registrert i adresseboka. Opprett nytt adressekort",
