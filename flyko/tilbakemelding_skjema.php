...
function taimotSkjema() {
	$resultat['success'] = mail("kayegil.hauan@svartlamon.org", "Feilmelding eller forbedringsforslag for leiebasen", $_POST['melding'], "From: {$this->bruker['navn']}<{$this->bruker['epost']}>");
